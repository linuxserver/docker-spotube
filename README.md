...
[![Scarf.io pulls](https://scarf.sh/installs-badge/linuxserver-ci/linuxserver%2Fspotube?color=94398d&label-color=555555&logo-color=ffffff&style=for-the-badge&package-type=docker)](https://scarf.sh/gateway/linuxserver-ci/docker/linuxserver%2Fspotube)
...
| Parameter | Function |
| :----: | --- |
| `-p 3000` | Spotube desktop gui. |
| `-p 3001` | HTTPS Spotube desktop gui. |
